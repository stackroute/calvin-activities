...
cqlsh -e "create table testdb.circlesFollowedByMailbox(mailboxId uuid, circleId uuid, startedFollowing timestamp, primary key(mailboxId,circleId)) WITH CLUSTERING ORDER BY (mailboxId DESC)"
