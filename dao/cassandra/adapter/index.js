...
function deleteDomain(domain, callback) {
    checkIfDomainExists(domain, function (err, domainDetail) {
        circleDAO.deleteCircle(domainDetail.circleid, function (err, result) {
...
function deleteUser(user, callback) {
    checkIfUserExists(user, function (err,userDetail) {
        mailboxDAO.deleteMailbox(userDetail.mailboxid, function (err, result) {
            if (err) { return callback(err); }
